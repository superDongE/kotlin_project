...
class QuestionAdapter1(val context: Context, val studyList: ArrayList<QuestionResponseResult>, val apply: Int) :
    RecyclerView.Adapter<QuestionAdapter1.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return QuestionAdapter1.ViewHolder(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.title?.text = studyList[position+5].choice
